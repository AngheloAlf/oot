...
s32 Collider_SetCylinderToActor(GameState* state, ColliderCylinder* collider, ColliderCylinderInitToActor* src);
s32 Collider_SetCylinderType1(GameState* state, ColliderCylinder* collider, Actor* actor,
                              ColliderCylinderInitType1* src);
s32 Collider_SetCylinder(GameState* state, ColliderCylinder* collider, Actor* actor, ColliderCylinderInit* src);
...
s32 CollisionCheck_SetAT_SAC(GameState* state, CollisionCheckContext* colChkCtx, Collider* collider, s32 index);
s32 CollisionCheck_SetAC(GameState* state, CollisionCheckContext* colChkCtx, Collider* collider);
s32 CollisionCheck_SetAC_SAC(GameState* state, CollisionCheckContext* colChkCtx, Collider* collider, s32 index);
s32 CollisionCheck_SetOC(GameState* state, CollisionCheckContext* colChkCtx, Collider* collider);
s32 CollisionCheck_SetOC_SAC(GameState* state, CollisionCheckContext* colChkCtx, Collider* collider, s32 index);
...
void Collider_SetTrisDim(GameState* state, ColliderTris* collider, s32 index, ColliderTrisElementDimInit* init);
...
void CollisionCheck_SpawnShieldParticlesMetalSound(GameState* state, Vec3f* v, Vec3f* actorPos);
void CollisionCheck_SpawnShieldParticlesMetal2(GameState* state, Vec3f* v);
void CollisionCheck_SpawnShieldParticlesWood(GameState* state, Vec3f* b, Vec3f* actorPos);
