...
void EffectBlure_AddVertex(EffectBlure* this_, Vec3f* p1, Vec3f* p2);
void EffectBlure_AddSpace(EffectBlure* this_);
...
void EffectSs_DrawGEffect(GlobalContext* globalCtx, EffectSs* this_, void* texture);
...
void SSNodeList_Alloc(GlobalContext* globalCtx, SSNodeList* this_, s32 tblMax, s32 numPolys);
u16 SSNodeList_GetNextNodeIdx(SSNodeList* this_);
...
void PreNmiBuff_Init(PreNmiBuff* this_);
void PreNmiBuff_SetReset(PreNmiBuff* this_);
u32 PreNmiBuff_IsResetting(PreNmiBuff* this_);
...
void func_8008F470(GlobalContext* globalCtx, void** skeleton, Vec3s* jointTable, s32 dListCount, s32 lod, s32 tunic,
                   s32 boots, s32 face, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, void* this_);
...
void func_800ACE70(struct_801664F0* this_);
void func_800ACE90(struct_801664F0* this_);
void func_800ACE98(struct_801664F0* this_, Gfx** gfxp);
void VisMono_Init(VisMono* this_);
void VisMono_Destroy(VisMono* this_);
void VisMono_UpdateTexture(VisMono* this_, u16* tex);
Gfx* VisMono_DrawTexture(VisMono* this_, Gfx* gfx);
void VisMono_Draw(VisMono* this_, Gfx** gfxp);
void VisMono_DrawOld(VisMono* this_);
void func_800AD920(struct_80166500* this_);
void func_800AD950(struct_80166500* this_);
void func_800AD958(struct_80166500* this_, Gfx** gfxp);
void Skybox_Init(GameState* state, SkyboxContext* skyboxCtx, s16 skyboxId);
Mtx* SkyboxDraw_UpdateMatrix(SkyboxContext* skyboxCtx, f32 x, f32 y, f32 z);
void SkyboxDraw_Draw(SkyboxContext* skyboxCtx, GraphicsContext* gfxCtx, s16 skyboxId, s16 blend, f32 x, f32 y, f32 z);
void SkyboxDraw_Update(SkyboxContext* skyboxCtx);
void PlayerCall_InitFuncPtrs(void);
void TransitionUnk_InitGraphics(TransitionUnk* this_);
void TransitionUnk_InitData(TransitionUnk* this_);
void TransitionUnk_Destroy(TransitionUnk* this_);
TransitionUnk* TransitionUnk_Init(TransitionUnk* this_, s32 row, s32 col);
void TransitionUnk_SetData(TransitionUnk* this_);
void TransitionUnk_Draw(TransitionUnk* this_, Gfx**);
void func_800B23E8(TransitionUnk* this_);
void TransitionTriforce_Start(void* this_);
void* TransitionTriforce_Init(void* this_);
void TransitionTriforce_Destroy(void* this_);
void TransitionTriforce_Update(void* this_, s32 updateRate);
void TransitionTriforce_SetColor(void* this_, u32 color);
void TransitionTriforce_SetType(void* this_, s32 type);
void TransitionTriforce_Draw(void* this_, Gfx** gfxP);
s32 TransitionTriforce_IsDone(void* this_);
void TransitionWipe_Start(void* this_);
void* TransitionWipe_Init(void* this_);
void TransitionWipe_Destroy(void* this_);
void TransitionWipe_Update(void* this_, s32 updateRate);
void TransitionWipe_Draw(void* this_, Gfx** gfxP);
s32 TransitionWipe_IsDone(void* this_);
void TransitionWipe_SetType(void* this_, s32 type);
void TransitionWipe_SetColor(void* this_, u32 color);
...
void TransitionFade_Start(void* this_);
void* TransitionFade_Init(void* this_);
void TransitionFade_Destroy(void* this_);
void TransitionFade_Update(void* this_, s32 updateRate);
void TransitionFade_Draw(void* this_, Gfx** gfxP);
s32 TransitionFade_IsDone(void* this_);
void TransitionFade_SetColor(void* this_, u32 color);
void TransitionFade_SetType(void* this_, s32 type);
...
void PreRender_SetValuesSave(PreRender* this_, u32 width, u32 height, void* fbuf, void* zbuf, void* cvg);
void PreRender_Init(PreRender* this_);
void PreRender_SetValues(PreRender* this_, u32 width, u32 height, void* fbuf, void* zbuf);
void PreRender_Destroy(PreRender* this_);
void func_800C0F28(PreRender* this_, Gfx** gfxp, void* buf, void* bufSave);
void func_800C1258(PreRender* this_, Gfx** gfxp);
void func_800C170C(PreRender* this_, Gfx** gfxp, void* fbuf, void* fbufSave, u32 r, u32 g, u32 b, u32 a);
void func_800C1AE8(PreRender* this_, Gfx** gfxp, void* fbuf, void* fbufSave);
void func_800C1B24(PreRender* this_, Gfx** gfxp, void* fbuf, void* cvgSave);
void func_800C1E9C(PreRender* this_, Gfx** gfxp);
void func_800C1F20(PreRender* this_, Gfx** gfxp);
void func_800C1FA4(PreRender* this_, Gfx** gfxp);
void func_800C20B4(PreRender* this_, Gfx** gfxp);
void func_800C2118(PreRender* this_, Gfx** gfxp);
void func_800C213C(PreRender* this_, Gfx** gfxp);
void func_800C24BC(PreRender* this_, Gfx** gfxp);
void func_800C24E0(PreRender* this_, Gfx** gfxp);
void func_800C2500(PreRender* this_, s32 x, s32 y);
void func_800C2FE4(PreRender* this_);
void PreRender_Calc(PreRender* this_);
...
void func_800C55D0(GameAlloc* this_);
void* GameAlloc_MallocDebug(GameAlloc* this_, u32 size, const char* file, s32 line);
void* GameAlloc_Malloc(GameAlloc* this_, u32 size);
void GameAlloc_Free(GameAlloc* this_, void* data);
void GameAlloc_Cleanup(GameAlloc* this_);
void GameAlloc_Init(GameAlloc* this_);
...
ListAlloc* ListAlloc_Init(ListAlloc* this_);
void* ListAlloc_Alloc(ListAlloc* this_, u32 size);
void ListAlloc_Free(ListAlloc* this_, void* data);
void ListAlloc_FreeAll(ListAlloc* this_);
...
// this_ function must remain commented out, because it is called incorrectly in
...
void SpeedMeter_InitImpl(SpeedMeter* this_, u32 arg1, u32 y);
void SpeedMeter_Init(SpeedMeter* this_);
void SpeedMeter_Destroy(SpeedMeter* this_);
void SpeedMeter_DrawTimeEntries(SpeedMeter* this_, GraphicsContext* gfxCtx);
...
void SpeedMeter_DrawAllocEntry(SpeedMeterAllocEntry* this_, GraphicsContext* gfxCtx);
...
void IrqMgr_AddClient(IrqMgr* this_, IrqMgrClient* c, OSMesgQueue* msgQ);
void IrqMgr_RemoveClient(IrqMgr* this_, IrqMgrClient* c);
void IrqMgr_SendMesgForClient(IrqMgr* this_, OSMesg msg);
void IrqMgr_JamMesgForClient(IrqMgr* this_, OSMesg msg);
void IrqMgr_HandlePreNMI(IrqMgr* this_);
void IrqMgr_CheckStack();
void IrqMgr_HandlePRENMI450(IrqMgr* this_);
void IrqMgr_HandlePRENMI480(IrqMgr* this_);
void IrqMgr_HandlePRENMI500(IrqMgr* this_);
void IrqMgr_HandleRetrace(IrqMgr* this_);
void IrqMgr_ThreadEntry(void* arg0);
void IrqMgr_Init(IrqMgr* this_, void* stack, OSPri pri, u8 retraceCount);
...
void GfxPrint_SetColor(GfxPrint* this_, u32 r, u32 g, u32 b, u32 a);
void GfxPrint_SetPosPx(GfxPrint* this_, s32 x, s32 y);
void GfxPrint_SetPos(GfxPrint* this_, s32 x, s32 y);
void GfxPrint_SetBasePosPx(GfxPrint* this_, s32 x, s32 y);
void GfxPrint_Init(GfxPrint* this_);
void GfxPrint_Destroy(GfxPrint* this_);
void GfxPrint_Open(GfxPrint* this_, Gfx* dList);
Gfx* GfxPrint_Close(GfxPrint* this_);
s32 GfxPrint_Printf(GfxPrint* this_, const char* fmt, ...);
