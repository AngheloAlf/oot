...
FILE_NAMES_DEBUG = FILES_CODE + FILES_ACTORS + FILES_OBJECTS + FILES_TEXTURES + FILES_SCENES_DEBUG + FILES_STATIC_MISC
FILE_NAMES_VANILLA = FILES_CODE + FILES_ACTORS + FILES_OBJECTS + FILES_TEXTURES + FILES_SCENES_VANILLA + FILES_STATIC_MISC
romData = None
...
def ExtractFunc(i):
    ...
    filename = 'baserom/' + FILE_NAMES_VANILLA[i]
...
def main():
    ...
    # TODO: don't hardcode
    for i in range(len(FILE_NAMES_VANILLA)):
        ExtractFunc(i)
