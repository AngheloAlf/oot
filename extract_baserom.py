...
# PAL MQ Debug and PAL MQ Vanilla has the same files in the same order.
FILES_ACTORS_PAL_MQ = [
    'ovl_En_Test',
    'ovl_Arms_Hook',
    'ovl_Arrow_Fire',
