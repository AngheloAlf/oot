...
python3 tools/compare_extracted_baseroms.py ../oot_master/baserom filelists/filelist_pal_mq_dbg.txt > logs/log_compare_extracted_baseroms_$1_vs_pal_mq_dbg.txt 2>&1
...
python3 tools/compare_extracted_baseroms.py ../oot_master/baserom filelists/filelist_pal_mq_dbg.txt --print equals > logs/log_compare_extracted_baseroms_equals_$1_vs_pal_mq_dbg.txt 2>&1
...
python3 tools/compare_extracted_baseroms.py ../oot_master/baserom filelists/filelist_pal_mq_dbg.txt --print diffs > logs/log_compare_extracted_baseroms_diffs_$1_vs_pal_mq_dbg.txt 2>&1
...
python3 tools/compare_extracted_baseroms.py ../oot_master/baserom filelists/filelist_pal_mq_dbg.txt --print missing > logs/log_compare_extracted_baseroms_missing_$1_vs_pal_mq_dbg.txt 2>&1
