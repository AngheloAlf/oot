...
void OceffWipe_Init(Actor* thisx, GameState* state);
void OceffWipe_Destroy(Actor* thisx, GameState* state);
void OceffWipe_Update(Actor* thisx, GameState* state);
void OceffWipe_Draw(Actor* thisx, GameState* state);
