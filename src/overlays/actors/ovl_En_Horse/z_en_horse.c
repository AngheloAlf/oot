...
struct unk_80A665DC D_80A665DC[] = { { 0xFF3D, 0xFFD8, 0x00E1, 0x0078, 0x0168, 0xC000, 0x07D0, 0xFEF2, 0xFFCC, 0xFF8B },
                                     { 0xFF3D, 0xFFD8, 0xFF10, 0xFF88, 0xFE98, 0x4000, 0x07D0, 0x010E, 0xFFCC,
                                       0xFF8B } };
...
s32 func_80A5B2F0(EnHorse* this, GlobalContext* globalCtx) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (D_80A665DC[i].unk0 < this->actor.world.pos.z && this->actor.world.pos.z < D_80A665DC[i].unk2) {
            if (min < this->actor.world.pos.x && this->actor.world.pos.x < max) {
                if (D_80A665DC[i].unkA - D_80A665DC[i].unkC < this->actor.world.rot.y &&
                    this->actor.world.rot.y < D_80A665DC[i].unkA + D_80A665DC[i].unkC) {
                    return 1;
                }
            }
        }
...
void func_80A5B61C(EnHorse* this, GlobalContext* globalCtx, struct unk_80A66654* arg3) {
    ...
    if (sp3C < 90000.0f) {
        ...
        if ((playerDist < 130.0f) || ((this->jntSph.elements[0].info.ocElemFlags & 2) != 0)) {
            if (Math_SinS((s16)(this->actor.yawTowardsPlayer - this->actor.world.rot.y)) > 0.0f) {
                this->actor.world.rot.y = this->actor.world.rot.y - 0x118;
            } else {
                this->actor.world.rot.y = this->actor.world.rot.y + 0x118;
            }
...
s32 func_80A5BBBC(GlobalContext* globalCtx, EnHorse* this, Vec3f* vec) {
    ...
    return func_800314D4(globalCtx, &this->actor, &sp24, sp20) || sp1C < 100.0f;
}
...
void func_80A5BC68(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_210 == 0) {
        if ((this->unk_214 > 35.0f && this->unk_158 == 0) || (this->unk_214 > 28.0f && this->unk_158 == 1)) {
            if ((this->unk_1F0 & 0x1000) == 0) {
                this->unk_1F0 |= 0x1000;
                Audio_PlaySoundGeneral((u16)0x282CU, &this->actor.projectedPos, (u8)4U, &D_801333E0, &D_801333E0,
                                       &D_801333E8);
                return;
            }
        }
    ...
    if (this->unk_210 == 3 && this->unk_214 > 25.0f) {
        if (!(this->unk_1F0 & 0x800)) {
            this->unk_1F0 |= 0x800;
            Audio_PlaySoundGeneral((u16)0x282BU, &this->actor.projectedPos, (u8)4U, &D_801333E0, &D_801333E0,
                                   &D_801333E8);
        }
    }
}
    ...
    for (i = 0; i < 169; i++) {
        if (D_80A65F40[i].unk0 == globalCtx->sceneNum) {
            ...
            if (globalCtx->sceneNum != 0x63
                ...
                || (Flags_GetEventChkInf(0x18) != 0 &&
                    ((gSaveContext.eventInf[0] & 0xF) != 6 || Flags_GetEventChkInf(0x18) != 0)) ||
                ...
                dist = Math3D_Vec3f_DistXYZ(&player->actor.world.pos, &vec);
                if (globalCtx->sceneNum) {}
                if (!(minDist < dist) && (func_80A5BBBC(globalCtx, this, &vec) == 0)) {
                    minDist = dist;
                    this->actor.world.pos.x = D_80A65F40[i].unk2.x;
                    this->actor.world.pos.y = D_80A65F40[i].unk2.y;
                    this->actor.world.pos.z = D_80A65F40[i].unk2.z;
                    this->actor.prevPos = this->actor.world.pos;
                    this->actor.world.rot.y = D_80A65F40[i].unk8;
...
s32 func_80A5BFF8(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if ((player->stateFlags1 & 1) || func_8002DD78(PLAYER) == 1 || (player->stateFlags1 & 0x00100000) ||
        ((this->unk_1F0 & 0x80000) && this->unk_388 == 0) || this->unk_14C == 0x12 ||
...
void EnHorse_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params & 0x8000) != 0) {
        ...
        do {
        } while (Object_IsLoaded(&gc->objectCtx, this->unk_15C) == 0);

        this->actor.objBankIndex = this->unk_15C;
        Actor_SetObjectDependency(gc, &this->actor);
        this->unk_208 = 0xC;
    } else {
        this->unk_158 = 0;
        this->unk_208 = 0xE;
    ...
    if ((gc->sceneNum == 0x63) && ((*gSaveContext.eventInf & 0xF) == 6) && (Flags_GetEventChkInf(0x18) == 0) &&
        (DREG(1) == 0)) {
    ...
    Collider_SetCylinder(gc, &this->cyl1, &this->actor, &sCylinderInit1);
    Collider_InitCylinder(gc, &this->cyl2);
    Collider_SetCylinder(gc, &this->cyl2, &this->actor, &sCylinderInit2);
    Collider_InitJntSph(gc, &this->jntSph);
    Collider_SetJntSph(gc, &this->jntSph, &this->actor, &sJntSphInit, &this->jntSphList);
    ...
    if (this->actor.params == 2) {
        ...
        func_80A5FCAC(this);
        this->rider = Actor_Spawn(&gc->actorCtx, gc, 0xCB, this->actor.world.pos.x, this->actor.world.pos.y,
...
void func_80A5C888(EnHorse* this, GlobalContext* globalCtx) {
    func_80A5B5E0(this, globalCtx, &PLAYER->actor.world.pos, (u16)0x190);
...
void func_80A5CAEC(EnHorse* this, GlobalContext* globalCtx, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6,
    ...
    if ((this->unk_1F0 & 1) != 0) {
        if ((0x10 - this->unk_240) > 0) {
            this->actor.speedXZ =
                (func_80A5BB14(this, globalCtx) * this->unk_208 - this->actor.speedXZ) / (0x10 - this->unk_240) +
                this->actor.speedXZ;
        } else {
...
void func_80A5CF64(EnHorse* this) {
    ...
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, curFrame,
                     Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3.0f);
}
s32 func_80A5BFF8(EnHorse* this, GlobalContext* globalCtx);
...
void func_80A5D1C4(EnHorse* this) {
    ...
    curFrame = this->unk_160.skelAnime.curFrame;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, curFrame,
                     (f32)Animation_GetLastFrame(sAnimationHeaders[this->unk_158][1]), 2, -3.0f);
...
void func_80A5D3C0(EnHorse* this) {
    ...
    this->unk_218 = 0;
    this->unk_210 = 4;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
                     (f32)Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][4]), 2, -3.0f);
}
...
void func_80A5DCB0(EnHorse* this) {
    ...
    this->unk_234 = 0;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
                     (f32)Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][6]), 2, -3.0f);
}
...
void func_80A5E2A8(EnHorse* this, GlobalContext* globalCtx) {
    ...
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.5f, 0.0f,
                     Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3.0f);
...
void func_80A5E5AC(EnHorse* this) {
    ...
    this->unk_218 = 0;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
                     (f32)Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][4]), 0, -3.0f);
}
...
void func_80A5E650(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if ((SkelAnime_Update(&this->unk_160.skelAnime) != 0) && ((f32)this->unk_150 <= 0.0f) &&
...
void func_80A5EA1C(EnHorse* this, GlobalContext* globalCtx) {
    ...
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.5f, sp34,
                     Animation_GetLastFrame(sAnimationHeaders[this->unk_158][7]), 2, -3.0f);
...
void func_80A5EB54(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->unk_160.skelAnime) ||
        ...
        func_80028A54(globalCtx, 25.0f, (Vec3f*)&this->actor.world);
...
void func_80A5F08C(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if ((DREG(53) != 0) && (this->unk_158 == 0)) {
        ...
        if (func_80A5BD94(this, gc) != 0) {
            Audio_PlaySoundGeneral((u16)0x2805U, &this->actor.projectedPos, (u8)4U, &D_801333E0, &D_801333E0,
                                   &D_801333E8);
            this->unk_1F0 &= ~0x2000;
...
void func_80A5F1B0(EnHorse* this, s32 arg1, f32 arg2, f32 arg3) {
    ...
    if (arg1 != this->unk_210) {
        ...
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, arg3,
                         Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][this->unk_210]), 2, arg2);
    }
}
...
void func_80A5F414(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if ((DREG(53) != 0) && (this->unk_158 == 0)) {
        DREG(53) = (u16)0;
        if (func_80A5BBBC(globalCtx, this, &this->actor.world.pos) == 0) {
...
void func_80A5F5F8(EnHorse* this, s32 arg1, f32 arg2, f32 arg3) {
    ...
    if (this->unk_210 != arg1) {
        this->unk_210 = arg1;
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, arg3,
                         Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, arg2);
    } else {
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, arg3,
                         Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, 0.0f);
    }
}
void func_80A5F760(EnHorse* this, GlobalContext* globalCtx) {
    s32 phi_s0 = 4;
...
void func_80A5FDD4(EnHorse* this) {
    ...
    if (phi_v1 == 1) {
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210],
                         sPlaybackSpeeds[this->unk_210] * sp30 * 1.5f, 0,
                         Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3);
    } else {
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210],
                         sPlaybackSpeeds[this->unk_210] * sp30 * 1.5f, 0,
                         Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, 0);
    }
}
...
void func_80A600E8(EnHorse* this, GlobalContext* globalCtx) {
    ...
    func_80A5FD30(this->unk_210, this->unk_160.skelAnime.curFrame, this->unk_394 & 1, (s16*)((u8*)this->rider + 0x1e6),
                  (f32*)((u8*)this->rider + 0x1e0));
}

void func_80A60294(EnHorse* this, GlobalContext* globalCtx, CsCmdActorAction* action) {
    this->unk_210 = 6;
    this->unk_380 = 1;
    Animation_PlayOnceSetSpeed(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][6],
...
void func_80A60300(EnHorse* this, GlobalContext* globalCtx, CsCmdActorAction* action) {
    ...
    if (SkelAnime_Update(&this->unk_160.skelAnime) != 0) {
        ...
        Animation_PlayOnceSetSpeed(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210],
                                   this->actor.speedXZ * 0.3f);
    }
}
...
void func_80A60470(EnHorse* this, GlobalContext* globalCtx) {
    ...
    this->unk_210 = 8;
    curFrame = this->unk_160.skelAnime.curFrame;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.5f, curFrame,
                     Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3.0f);
    this->unk_244 = NULL;
    this->unk_274 = this->actor.world.pos.y;
    this->actor.gravity = 0.0f;
...
void func_80A60954(EnHorse* this, GlobalContext* globalCtx, CsCmdActorAction* action) {
    ...
    if (SkelAnime_Update(&this->unk_160.skelAnime) != 0) {
        ...
        Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
                         Animation_GetLastFrame(sAnimationHeaders[this->unk_158][this->unk_210]), 0, 0.0f);
    }
}
...
void func_80A60D28(EnHorse* this, GlobalContext* globalCtx, CsCmdActorAction* action) {
    this->actor.world.pos.x = (f32)action->startPos.x;
    this->actor.world.pos.y = (f32)action->startPos.y;
    this->actor.world.pos.z = (f32)action->startPos.z;
    this->actor.prevPos = this->actor.world.pos;
    this->actor.world.rot.y = action->urot.y;
    this->actor.shape.rot = this->actor.world.rot;
    this->unk_210 = 3;
    ...
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
                     Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3.0f);
}
...
s32 func_80A6121C(EnHorse* this, GlobalContext* globalCtx, struct unk_80A66654* D_80A66730) {
    ...
    if ((this->unk_204 >= (D_80A66730->unk_00 - 1)) &&
        Math3D_Vec3f_DistXYZ(&sp3C, &this->actor.world.pos) < (f32)DREG(8)) {
        ...
        if ((this->unk_210 == 0) || (this->unk_210 == 1)) {
            if (phi_a2 != this->unk_210) {
                ...
                if (Rand_ZeroOne() > 0.5f) {
                    ...
                    this->unk_21C = this->unk_228;
                    if (this->unk_1F0 & 0x08000000) {
                        Audio_PlaySoundGeneral((u16)0x2816U, &this->unk_21C, (u8)4U, &D_801333E0, &D_801333E0,
                                               &D_801333E8);
                    }
                }
                Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.0f, 0.0f,
...
void func_80A62278(EnHorse* this, GlobalContext* globalCtx) {
    ...
    this->unk_258.y -= y;
    this->unk_1F0 |= 8;
    this->unk_3C4 = this->actor.world.rot.y - D_80A665DC[this->unk_3AC].unkA;
    this->unk_3BC = 0;
    this->actor.gravity = 0.0f;
    this->actor.speedXZ = 0;
    Animation_Change(&this->unk_160.skelAnime, sAnimationHeaders[this->unk_158][this->unk_210], 1.5f, 0.0f,
                     (f32)Animation_GetLastFrame((void*)sAnimationHeaders[this->unk_158][this->unk_210]), 2, -3.0f);
    this->unk_21C = this->unk_228;
    if (this->unk_1F0 & 0x08000000) {
        Audio_PlaySoundGeneral((u16)0x2805U, &this->unk_21C, (u8)4U, &D_801333E0, &D_801333E0, &D_801333E8);
    }
...
void func_80A6255C(EnHorse* this, GlobalContext* globalCtx) {
    ...
    this->actor.world.pos.x = ((D_80A665DC[this->unk_3AC].unkE - this->unk_3B0.x) * temp_f14) + this->unk_3B0.x;
    this->actor.world.pos.z = ((D_80A665DC[this->unk_3AC].unk12 - this->unk_3B0.z) * temp_f14) + this->unk_3B0.z;

    this->actor.world.pos.y = (this->unk_3B0.y + (this->unk_3C0 * this->unk_3BC) + (-0.4f * temp_f2));

    this->actor.world.rot.y = this->actor.shape.rot.y =
        (D_80A665DC[this->unk_3AC].unkA + ((1.0f - temp_f14) * this->unk_3C4));
...
void func_80A626B8(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->unk_160.skelAnime) != 0) {
        this->unk_1F0 &= ~4;
        this->actor.gravity = -3.5f;
        this->actor.world.pos.y = D_80A665DC[this->unk_3AC].unk10;
        func_80028A54(globalCtx, 25.0f, &this->actor.world.pos);
        func_80A5DDB0(this, globalCtx);
        Audio_PlaySoundGeneral((u16)0x2819U, &this->actor.projectedPos, (u8)4U, &D_801333E0, &D_801333E0, &D_801333E8);
        func_800AA000(0.0f, (u8)0xFFU, (u8)0xAU, (u8)0x50U);
...
s32 func_80A62868(EnHorse* this, GlobalContext* globalCtx, Vec3f* vec, CollisionPoly** floorPoly, f32* arg4) {
    ...
    *arg4 = BgCheck_EntityRaycastFloor3(&globalCtx->colCtx, floorPoly, &sp3C, vec);
    ...
    if ((*floorPoly)->normal.y * 0.00003051851f < 0.81915206f ||
        SurfaceType_IsHorseBlocked(&globalCtx->colCtx, *floorPoly, sp3C) ||
        func_80041D4C(&globalCtx->colCtx, *floorPoly, sp3C) == 7) {
        return 3;
    }
    return 0;
}
...
void func_80A629A4(EnHorse* this, GlobalContext* globalCtx, s32 arg3, s32 arg4) {
    ...
    this->actor.world.pos = this->unk_1F4;
    this->actor.shape.rot.y = this->unk_200;
    this->actor.world.rot.y = this->unk_200;
    this->unk_1F0 |= 0x4000;
...
void func_80A62ACC(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.floorPoly != 0) {
        ...
        this->actor.shape.yOffset =
            (this->unk_248 + (((this->unk_24C - this->unk_248) * 20.0f) / 45.0f)) - this->actor.floorHeight;
    }
}
...
void func_80A6304C(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((temp_v0 != 0) && !(this->unk_1F0 & 0x00010000) && (player->rideActor == 0)) {
        func_8002F63C(gc, &this->actor, temp_v0);
    }
    if ((this->unk_20C == 0) && (Actor_HasChild(gc, &this->actor) == 1)) {
        this->unk_150 = 0x37;
        this->unk_154 = 0x37;
        this->unk_20C = v1;
        func_80A5C8FC(this);
    } else if ((this->unk_20C == 1) && (Actor_HasNoChild(gc, &this->actor) == 1)) {
        this->unk_150 = 0x23;
        this->unk_154 = 0x23;
        this->unk_1F0 &= ~0x10000;
        this->unk_20C = 0;
...
void func_80A634A0(EnHorse* this, GlobalContext* globalCtx) {
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &this->actor, globalCtx->sceneNum == 99 ? 19.0f : 40.0f, 35.0f, 100.0f, 29);
            ...
            if (((this->unk_1F0 & 1) == 0) && ((this->unk_1F0 & 0x100) == 0) && ((this->unk_1F0 & 0x200) == 0)) {
                ...
                if (this->unk_1F0 & 0x08000000) {
                    if (Rand_ZeroOne() < 0.1f) {
                        Audio_PlaySoundGeneral((u16)0x2805U, &this->unk_21C, (u8)4U, &D_801333E0, &D_801333E0,
                                               &D_801333E8);
                    }
                }
            }
...
void func_80A64150(EnHorse* this, GlobalContext* globalCtx) {
    ...
    if (((s32)this->unk_238 < 6) && ((s32)this->unk_238 > 0)) {
        ...
        if ((s32)this->unk_23C <= 0) {
            ...
            if ((this->unk_14C == 5 || this->unk_14C == 0 || this->unk_14C == 6) && !(this->unk_1F0 & 0x00080000) &&
                !(this->unk_1F0 & 0x02000000)) {
                phi_v0 = 1;
            } else {
                phi_v0 = 0;
            }
...
void EnHorse_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->unk_1F0 & 0x80000) {
        if ((this->unk_1F0 & 0x100000) && (this->unk_388 == 1)) {
            ...
            func_80A5E00C(this);
        } else if (((this->unk_1F0 & 0x100000) == 0) && (this->unk_1F0 & 0x200000) && (this->unk_14C != 0xB) &&
                   (this->unk_388 == 1)) {
    ...
    if ((this->unk_1F0 & 0x2000) == 0) {
        ...
        if (((player->stateFlags1 & 1) != 0) && (player->rideActor != 0)) {
            if (gc->sceneNum != 0x63 || (gc->sceneNum == 0x63 && (thisx->world.pos.z < -2400.0f))) {
        ...
        if (!(this->unk_1F0 & 0x01000000)) {
            ...
            if (thisx->world.pos.y < this->unk_248) {
                if (thisx->world.pos.y < this->unk_24C) {
                    if (this->unk_24C < this->unk_248) {
                        thisx->world.pos.y = this->unk_24C;
                    } else {
                        thisx->world.pos.y = this->unk_248;
                    }
                }
            }
        } else {
        ...
        if ((gSaveContext.entranceIndex != 0x157) || (gSaveContext.sceneSetupIndex != 9)) {
            if ((this->unk_3C8 & 1) != 0) {
                this->unk_3C8 &= 0xFFFE;
                func_800287AC(gc, &this->unk_3CC, &sp50, &sp5C, func_80A6467C(100) + 0xC8, func_80A6467C(10) + 0x1E,
                              func_80A6467C(20) + 0x1E);
            } else if ((this->unk_3C8 & 2) != 0) {
                this->unk_3C8 &= 0xFFFD;
                func_800287AC(gc, &this->unk_3D8, &sp50, &sp5C, func_80A6467C(100) + 0xC8, func_80A6467C(10) + 0x1E,
                              func_80A6467C(20) + 0x1E);
            } else if ((this->unk_3C8 & 4) != 0) {
                this->unk_3C8 &= 0xFFFB;
                func_800287AC(gc, &this->unk_3E4, &sp50, &sp5C, func_80A6467C(100) + 0xC8, func_80A6467C(10) + 0x1E,
                              func_80A6467C(20) + 0x1E);
            } else if ((this->unk_3C8 & 8) != 0) {
                this->unk_3C8 &= 0xFFF7;
                func_800287AC(gc, &this->unk_3F0, &sp50, &sp5C, func_80A6467C(100) + 0xC8, func_80A6467C(10) + 0x1E,
                              func_80A6467C(20) + 0x1E);
            }
        }
...
s32 func_80A64F14(EnHorse* this, GlobalContext* globalCtx, Player* player) {
    ...
    if (Actor_WorldDistXZToActor(&this->actor, (Actor*)player) > 75.0f) {
        return 0;
...
void func_80A65108(Actor* thisx, GlobalContext* globalCtx, PSkinAwb* skin) {
    ...
    if ((this->unk_210 == 0 && this->unk_14C != 0) && ((frame > 40.0f && frame < 45.0f && this->unk_158 == 0) ||
                                                       (frame > 28.0f && frame < 33.0f && this->unk_158 == 1))) {
