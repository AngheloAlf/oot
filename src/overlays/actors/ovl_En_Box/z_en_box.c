...
void EnBox_Init(Actor* thisx, GameState* state);
void EnBox_Destroy(Actor* thisx, GameState* state);
void EnBox_Update(Actor* thisx, GameState* state);
void EnBox_Draw(Actor* thisx, GameState* state);
