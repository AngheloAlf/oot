...
void EnWf_Init(Actor* thisx, GameState* state);
void EnWf_Destroy(Actor* thisx, GameState* state);
void EnWf_Update(Actor* thisx, GameState* state);
void EnWf_Draw(Actor* thisx, GameState* state);
