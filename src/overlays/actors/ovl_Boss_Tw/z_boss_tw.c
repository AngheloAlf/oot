...
void BossTw_Init(Actor* thisx, GameState* state);
void BossTw_Destroy(Actor* thisx, GameState* state);
void BossTw_Update(Actor* thisx, GameState* state);
void BossTw_Draw(Actor* thisx, GameState* state);
