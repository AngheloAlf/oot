...
void BossGanon2_Init(Actor* thisx, GameState* state);
void BossGanon2_Destroy(Actor* thisx, GameState* state);
void BossGanon2_Update(Actor* thisx, GameState* state);
void BossGanon2_Draw(Actor* thisx, GameState* state);
