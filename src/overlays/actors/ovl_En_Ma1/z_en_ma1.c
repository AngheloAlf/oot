...
void EnMa1_Init(Actor* thisx, GameState* state);
void EnMa1_Destroy(Actor* thisx, GameState* state);
void EnMa1_Update(Actor* thisx, GameState* state);
void EnMa1_Draw(Actor* thisx, GameState* state);
