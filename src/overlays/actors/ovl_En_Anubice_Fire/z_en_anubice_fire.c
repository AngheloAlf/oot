...
void EnAnubiceFire_Init(Actor* thisx, GameState* state);
void EnAnubiceFire_Destroy(Actor* thisx, GameState* state);
void EnAnubiceFire_Update(Actor* thisx, GameState* state);
void EnAnubiceFire_Draw(Actor* thisx, GameState* state);
