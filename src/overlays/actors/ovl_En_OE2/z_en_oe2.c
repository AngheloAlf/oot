...
void EnOE2_Init(Actor* thisx, GameState* state);
void EnOE2_Destroy(Actor* thisx, GameState* state);
void EnOE2_Update(Actor* thisx, GameState* state);
void EnOE2_Draw(Actor* thisx, GameState* state);
