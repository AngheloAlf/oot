...
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { 0x0108, 2, 0xA4, 0x02003D70 },       { 0x0138, 1, 0xA5, 0x02003F40 },      { 0x014D, 2, 0xA6, gGoronCityEnterFirstTimeCs },
    ...
    { 0x0129, 2, 0xB3, 0x02006490 },       { 0x0157, 2, 0xB4, gSpot20LonLonRanchEnterFirstTimeCs },      { 0x0028, 2, 0xB5, 0x02015600 },
